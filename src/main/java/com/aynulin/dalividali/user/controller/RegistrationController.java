package com.aynulin.dalividali.user.controller;


import com.aynulin.dalividali.security.dto.RegistrationForm;
import com.aynulin.dalividali.security.util.SecurityUtil;
import com.aynulin.dalividali.user.model.SocialMediaService;
import com.aynulin.dalividali.user.model.User;
import com.aynulin.dalividali.user.service.DuplicateEmailException;
import com.aynulin.dalividali.user.service.UserService;
...
public class RegistrationController {
    ...
    protected static final String ERROR_CODE_PASSWORDS_DOESNT_MATCH = "PasswordsNotEqual.user.password";
    ...
    private User createUserAccount(RegistrationForm userAccountData, BindingResult result) {
        ...
        if (userAccountData.getPassword() != null && !userAccountData.getPassword().equals(userAccountData.getPasswordVerification())) {
            addFieldError(
                    MODEL_NAME_REGISTRATION_DTO,
                    RegistrationForm.FIELD_NAME_VERIFICATION_PASSWORD,
                    userAccountData.getEmail(),
                    ERROR_CODE_PASSWORDS_DOESNT_MATCH,
                    result);
            return registered;
        }
        try {
